...
function buildContext({ video, captions, news, comments, artist, topic, type, hook, reason, keywords, articleText, articleSite, articleUrl }) {
  const lines = []
...
export async function POST(req) {
  ...
  const { format, video, captions, news, comments, artist, topic, type, hook, reason, keywords, articleText, articleSite, articleUrl } = body
  ...
  const ctx = buildContext({ video, captions, news, comments, artist, topic, type, hook, reason, keywords, articleText, articleSite, articleUrl })
